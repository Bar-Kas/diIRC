...
export const useConnectionStatus = (targetServerId?: string): ConnectionStatuses => {
  ...
  const activeServerId = targetServerId || serverId || (servers.length > 0 ? servers[0].id : null);
